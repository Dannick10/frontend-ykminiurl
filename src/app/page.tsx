...
export default function Home() {
  ...
  return (
    <section className="flex flex-col gap-30 px-30 py-10">
        ...
        <Alert title="sucesso" subtitle="seu link está pronto para ser copiado" colors="green" />
      ...
      <aside className="flex justify-center items-center flex-wrap">
        <div className="flex flex-col justify-center items-center gap-2 max-w-[600px]">
          ...
          <div className="flex flex-col justify-center items-center py-38 gap-5  my-9 ">
            ...
            <button className="flex  justify-center items-center px-[13px] py-1 rounded-[24px] border-[1px] border-[#BF2C0B] text-[#BF2C0B]" onClick={handleVisibilityPassword}>adicionar senha</button>
            </div>
            {viewPassword && 
            <div className="border-2 rounded-[20px] py-1.5 px-1.5 w-[367px] border-[#BF2C0B] overflow-hidden relative flex">
                <input type="text" placeholder="digite uma senha" className="w-full h-full font-sora font-light outline-none px-4 py-2 text-[#211D26]  " />
            </div>
            
            }

            <div className="border-2 rounded-[20px] py-1.5 px-1.5 w-[367px] border-[#BF2C0B] overflow-hidden relative flex">
                <input type="text" placeholder="Cole seu link" className="w-full h-full font-sora font-light outline-none px-4 py-2 text-[#211D26]  " />
