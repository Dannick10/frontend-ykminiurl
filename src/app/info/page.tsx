...
const page = () => {
   const {handleVisibilityPassword, viewPassword,} = usePassword()
    const {
    postInfoLink,
      msg,
      loading,
        ...
        <aside className="flex justify-center items-center flex-wrap">
          <div className="flex flex-col justify-center items-center gap-2 max-w-[600px]">
            <div className="space-y-2">
              ...
              Deseja ter informações do seu <span className='text-[#BF2C0B]'>link</span> ?
              </h1>
              <p className="font-light text-[24px] text-[#0A0A0D] font-sora">
              cole seu link encurtado,  digite a senha se o link estiver com segurança.
              </p>
            </div>
          ...
          <div className="relative w-[80vh] h-[80vh]">
            <Image src={womanpoint} alt="woman" fill style={{ objectFit: "cover" }} />
          </div>
        </aside>
      </section>
    );
