    ...
    <main className="min-h-screen bg-gradient-to-b from-white to-blue-50 py-16 md:py-20">
      {msg.status && (
        <Alert
          ...
          colors={msg.color}
          handleCloseMsg={() => Setmsg({ title: "", subtitle: "", color: "green", status: false })}
        />
      )}
      ...
      <section className="container mx-auto px-4">
        ...
        >
          <h1 className="text-3xl md:text-4xl font-bold text-[#034C8C] mb-4">Estatísticas do Link</h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Veja informações detalhadas sobre o desempenho do seu link encurtado.
          </p>
        </motion.div>
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="bg-blue-50 rounded-lg p-6 flex flex-col items-center justify-center">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-[#BF2C0B] mb-1">{clicks || 0}</h3>
                ...
                <div className="bg-blue-50 rounded-lg p-6 flex flex-col items-center justify-center">
                  ...
                  <h3 className="text-xl font-bold text-[#034C8C] mb-1">{dateFormat}</h3>
                  <p className="text-gray-600">Data de Criação</p>
                </div>
              </div>

              <div className="mb-8">
                <h3 className="text-lg font-semibold text-gray-800 mb-2">Seu link encurtado:</h3>
          ...
          >
            <div className="relative">
              ...
              <Image src="/database.svg" alt="Análise de dados" width={450} height={450} className="relative z-10" />
            </div>
          </motion.div>
        </div>
      </section>
